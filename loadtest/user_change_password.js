...
const instance = autocannon(
  {
    url: 'http://localhost:3000/api/v1/users/me/change-password',
    method: 'PATCH',
    headers: {
    ...
    connections: 50, // Password hashing is CPU intensive, use fewer connections
    duration: 30,
    pipelining: 1,
  },
  (err, result) => {
    if (err) {
      ...
      console.log('--- RESULTS: USER CHANGE PASSWORD STRESS TEST ---');
